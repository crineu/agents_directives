<!-- https://akitaonrails.com/2026/04/20/clean-code-para-agentes-de-ia/#instruindo-o-agente-a-escrever-c%c3%b3digo-limpo -->
...
- Follow the framework's convention (Rails, Django, Next.js, Spring, etc).
